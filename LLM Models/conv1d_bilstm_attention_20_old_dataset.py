# -*- coding: utf-8 -*-
"""Conv1D_BiLSTM_ATTENTION_20_Old_Dataset.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1405sNWgESz7kzurizLrNdlieXDsLyXjf
"""
...
history = model1.fit([processed_x_train,processed_pre_x_train],y_train, validation_data=([processed_x_test ,processed_pre_x_test],y_test), epochs=20,batch_size=32,callbacks=[early_stopping_monitor],verbose=1)
...
history = model2.fit([processed_x_train,processed_pre_x_train],y_train, validation_data=([processed_x_test,processed_pre_x_test],y_test), epochs=20,batch_size=32,callbacks=[early_stopping_monitor],verbose=1)
