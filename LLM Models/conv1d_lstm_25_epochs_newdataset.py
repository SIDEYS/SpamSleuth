# -*- coding: utf-8 -*-
"""Conv1d_Lstm_25_epochs_NewDataset.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1g58JpQ5O-fAnGK9-mOAqza0IlGqmIzXS
"""
...
embeddings_index = {}
f = open(os.path.join('../input/glove-global-vectors-for-word-representation', '/content/drive/MyDrive/Glove_Embeddings/glove.6B.100d.txt'))
for line in f:
    values = line.split()
    word = values[0]
...
history = model_2lstm.fit(processed_x_train,y_train,validation_data=(processed_x_test,y_test),epochs=25,batch_size=32,verbose=1)
...
history = model.fit(processed_x_train,y_train,validation_data=(processed_x_test,y_test),epochs=25,batch_size=32,verbose=1)
...
history = model_1lstm.fit(processed_x_train,y_train,validation_data=(processed_x_test,y_test),epochs=25,batch_size=32,verbose=1)
