# -*- coding: utf-8 -*-
"""Conv1d_Lstm_15_epochs_NewDataset.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1HcRNkxwx8vkaGl23fzrBQdOvhUyJWd-a
"""
...
history = model_2lstm.fit(processed_x_train,y_train,validation_data=(processed_x_test,y_test),epochs=15,batch_size=32,verbose=1)
...
history = model_1lstm.fit(processed_x_train,y_train,validation_data=(processed_x_test,y_test),epochs=15,batch_size=32,verbose=1)
